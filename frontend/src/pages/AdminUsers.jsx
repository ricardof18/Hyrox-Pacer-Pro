                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-white/5 bg-[#1a1a1a]/50">
                                    ...
                                    <th className="px-8 py-6 text-[10px] font-black text-gray-500 uppercase tracking-widest italic">Categoria</th>
                                    ...
                                    <tr key={u.id} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className="text-sm font-black text-white italic uppercase">{u.full_name || 'N/A'}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-8 py-6 text-[10px] font-black text-gray-500 uppercase tracking-widest">{u.categoria_hyrox}</td>
